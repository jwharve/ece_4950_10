...
MODEL           = proj3
MODULES         = rt_matrx.c rt_printf.c rt_logging.c proj3_capi.c proj3_data.c proj3_xcp.c proj3_xcp_TET.c rtGetInf.c rtGetNaN.c rt_nonfinite.c xpc_datatype_ground.c rt_logging_mmi.c rtw_modelmap_utils.c host_timer_x86.c xpc_code_profiling_utility_functions.c
MAKEFILE        = proj3.mk
...
MASTER_ANCHOR_DIR = 
START_DIR       = C:\Users\Joshua\DOCUME~1\School\2018-19\Fall\ECE495~1\PROJEC~3\Simulink\both
...
MULTITASKING    = 0
EXT_MODE        = 0
MEX_OPT_FILE    = -f "C:\Users\Joshua\AppData\Roaming\MathWorks\MATLAB\R2017b\mex_C_win64.xml"
...
MODELLIB                  = proj3lib.lib
MODELREF_LINK_LIBS        = 
MODELREF_LINK_RSPFILE     = proj3_ref.rsp
MODELREF_INC_PATH         = 
...
MATLAB_INCLUDES = $(MATLAB_INCLUDES);$(START_DIR)\proj3_slrt_rtw
MATLAB_INCLUDES = $(MATLAB_INCLUDES);$(MATLAB_ROOT)\rtw\c\src\ext_mode\common
