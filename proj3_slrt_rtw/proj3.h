...
#ifndef RTW_HEADER_proj3_h_
#define RTW_HEADER_proj3_h_
#include <stddef.h>
#include <string.h>
#include "rtw_modelmap.h"
#ifndef proj3_COMMON_INCLUDES_
# define proj3_COMMON_INCLUDES_
...
#endif                                 /* proj3_COMMON_INCLUDES_ */

#include "proj3_types.h"
...
#define rtmGetRTWSolverInfo(rtm)       &((rtm)->solverInfo)
#define rtModel_proj3                  RT_MODEL_proj3_T

/* Definition for use in the target main file */
#define proj3_rtModel                  RT_MODEL_proj3_T
...
typedef struct {
  ...
  real_T uUsesimulatedmotor0Userealmotor;/* '<Root>/1 - Use simulated motor 0 - Use real motor' */
...
#define StateDerivatives               XDot_proj3_T
#define tXdis                          proj3_XDis
#define StateDisabled                  XDis_proj3_T
#define rtY                            proj3_Y
#define ExternalOutputs                ExtY_proj3_T
#define rtP                            proj3_P
#define Parameters                     P_proj3_T
#define rtDWork                        proj3_DW
#define D_Work                         DW_proj3_T
...
extern P_proj3_T proj3_P;

/* Block signals (auto storage) */
extern B_proj3_T proj3_B;

/* Continuous states (auto storage) */
extern X_proj3_T proj3_X;
...
extern void proj3_initialize(void);
extern void proj3_output(void);
extern void proj3_update(void);
extern void proj3_terminate(void);

/*====================*
 * External functions *
 *====================*/
extern proj3_rtModel *proj3(void);
...
extern RT_MODEL_proj3_T *const proj3_M;
 ...
 *
 * '<Root>' : 'proj3'
 * '<S1>'   : 'proj3/Data Display'
 * '<S2>'   : 'proj3/Real motor'
 * '<S3>'   : 'proj3/Simulated motor'
 * '<S4>'   : 'proj3/error signal'
 * '<S5>'   : 'proj3/input side switching logic'
 * '<S6>'   : 'proj3/motor position'
 * '<S7>'   : 'proj3/setpoint'
 * '<S8>'   : 'proj3/switching logic'
 */
#endif                                 /* RTW_HEADER_proj3_h_ */
